...
<head>
    ...
    <title>Technical Briefings \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    <!-- InstanceEndEditable -->
    ...
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                &gt; <a href="<?php echo $siteRoot; ?>publications/technical-briefings">Technical Briefings</a>
			<!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
                <h2>Technical Briefings</h2>
				<?php 
				//Set up path to XML
				//Load XML	
				// create new DOM and XPath objects and load the XML file
				$doc = new DOMDocument();
				$doc->load($techBriefXML);
				$xpath = new DOMXpath($doc);
								
				//Select the parent of all items
				$tbList = $doc->getElementsByTagName("item");

				//Nanoelectronics
				echo "<h3><a name=\"NCN Related Technical Briefings since Dec. 2003\"></a>NCN Related Technical Briefings since Dec. 2003</h3>";
				echo listItems("ncn", $tbList);
			?>
			<!-- InstanceEndEditable --> 
            </div>
            <div class="side-col">
