...
<head>
    ...
    <title>Panel Discussion Participation \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    <!-- InstanceEndEditable -->
    ...
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                &gt; <a href="<?php echo $siteRoot; ?>publications/panel-discussions">Panel Discussions</a>
			<!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
                <h2>Panel Discussion Participation</h2>
				<?php 
				//Set up path to XML
				//Load XML	
				...
				//Nanoelectronics
				echo "<h3><a name=\"Nanoelectronic / Grid Computing Paricipation\"></a>Nanoelectronics / Grid Computing Paricipation</h3>";
