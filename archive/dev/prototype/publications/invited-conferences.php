...
<head>
    ...
    <title>Invited Conferences Participation \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    <!-- InstanceEndEditable -->
    ...
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                &gt; <a href="<?php echo $siteRoot; ?>publications/invited-conferences">Invited Conferences</a>
			<!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
                <h2>Invited Conferences Participation</h2>
                <ul>
                    ...
                    <li><a href="#PHD Publications">Quantum Dots and RTD's at Purdue</a></li>
                </ul>
				<?php 
				//Set up path to XML
				//Load XML	
				...
				//PHD Related
				echo "<h3><a name=\"PHD Publications\"></a>Quantum Dots and RTD's at Purdue</h3>";
