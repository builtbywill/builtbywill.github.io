...
<head>
    ...
    <title>Seminar Presentations \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    <!-- InstanceEndEditable -->
    ...
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                &gt; <a href="<?php echo $siteRoot; ?>publications/invited-seminars">Invited Seminars</a>
			<!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
                ...
                <ul>
                    <li><a href="#JPL and Purdue Work">Nanoelectronics</a></li>
				...
				//Nanoelectronics				
				echo "<h3><a name=\"JPL and Purdue Work\"></a>Nanoelectronics</h3>";
