...
<head>
    ...
    <title>Technical Reports \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    <!-- InstanceEndEditable -->
    ...
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                &gt; <a href="<?php echo $siteRoot; ?>publications/technical-reports">Technical Reports</a>
			<!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
                ...
                <ul>
                    <li><a href="#JPL Related Reports">Nanoelectronics and Cluster Computing at JPL</a></li>
                    <li><a href="#NEMO Related Reports">NEMO Related Work at Raytheon / TI / UTD</a></li>
                    <li><a href="#PHD Technical Reports">Quantum Dots, RTD's and 2DEG's at Purdue</a></li>
                </ul>
				<?php 
				//Set up path to XML
				//Load XML	
				...
				//Nanoelectronics				
				echo "<h3><a name=\"JPL Related Reports\"></a>Nanoelectronics and Cluster Computing at JPL</h3>";
				...
				//PHD Related
				echo "<h3><a name=\"PHD Technical Reports\"></a>Quantum Dots, RTD's and 2DEG's at Purdue</h3>";
				echo listItems("phd", $trList);
			?>
			<!-- InstanceEndEditable --> 
            </div>
            <div class="side-col">
