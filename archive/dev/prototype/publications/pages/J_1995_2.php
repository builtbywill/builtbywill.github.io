...
<head>
    ...
    <title>J_1995_2 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_1995_2">J_1995_2</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J_1995_2  </h2>
				
		
		<h3>&quot;Quantum Device Simulation with a Generalized Tunneling Formula&quot;</h3>
		
		<p>Gerhard Klimeck, Roger K. Lake, R. Chris Bowen, William R. Frensley and Ted Moise</p>
		
		<p>Appl. Phys. Lett., Vol. 67, p.2539 (1995).</p>
		
		<h3>Abstract:</h3> <p>We present device simulations based on a generalized tunneling theory. The theory is compatible with standard coherent tunneling approaches and significantly increases the variety of devices that can be simulated. Quasi-bound and continuum states in the leads are treated on the same footing. Quantum charge self-consistency is included in the leads and the central device region. We compare the simulated I-V characteristics with the experimental I-V characteristics for two complex quantum device structures and find good agreement. (C) 1995 American Institute of Physics.</p>
		
		<p>Request a reprint in <a href="mailto:gekco_no_spaem@kein_spaem.purdue.edu?subject=Request J10.pdf">PDF</a> form.</p>
