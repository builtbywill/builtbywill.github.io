...
<head>
    ...
    <title>C_2004_5 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2004_5">C_2004_5</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2004_5 </h2>
				
		
		<h3>Efficient boundary condition for the electronic structure of embedded semiconductor nanostructures</h3>
		
		<p>Seungwon Lee, Fabiano Oyafuso, Paul von Allmen, Gerhard Klimeck</p>
		<p>March Meeting of the American Physical Society, March 22-26, Montreal, CA (2004).</p>
		<h3>Abstract:</h3> 
		
		<p>The modeling of semiconductor nanostructures that are embedded in a bulk material requires a proper boundary treatment for a finite simulation domain. For the study of a self-assembled InAs dot embedded in GaAs, three kinds of boundary conditions are examined within the empirical tight-binding model: (i) the periodic boundary condition, (ii) raising the orbital energies of surface atoms, and (iii) raising the energies of dangling bonds at the surface. The periodic boundary condition requires a smooth boundary and consequently a larger GaAs buffer than the two non-periodic boundary conditions. Between the non-periodic conditions, the dangling-bond energy shift is numerically more efficient than the orbital-energy shift, in terms of the elimination of non-physical surface states in the energy region of interest for confined states. A dangling-bond energy shift larger than 5 eV efficiently eliminates all of the surface states and leads to confined states that are highly insensitive to the choice of the energy shift.</p>
