...
<head>
    ...
    <title>P_2000_3 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/P_2000_3">P_2000_3</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck P_2000_3  </h2>
				
		
		<h3>Transverse Momentum Dependence of Electron and Hole Tunneling in a Full Band Tight-Binding Simulation</h3>
		
		<p>Gerhard Klimeck, R. Chris Bowen, and Timothy B. Boykin</p>
		<p>Proceedings of the 27th international Symposium on Compound Semiconductors (ISCS), IEEE, pg. 257 (2000)	</p>	
		<h3>Abstract:</h3> 
        
        <p>Heterointerfaces, applied bias and built-in potentials break the symmetry of the crystalline lattice in a resonant tunneling diode (RTD) which causes a strong interaction of heavy-, light- and split-off hole bands. This interaction leads to hole transport paths which are significantly more complicated than the paths for electrons. Compared to a direct bandgap electron RTD where most of the carriers are transported straight through the structure (zero transverse momentum)
		
		it is shown here that in the hole case most of the holes are transported through the structure at an angle (non-zero transverse momentum) for a wide range of bias points.</p>
		
		<p>Reprint in <a href="../pubs_src/P25.pdf">PDF</a> form.</p>
