...
<head>
    ...
    <title>J_2002_4 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
...
<!-- @end mast -->
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_2002_4">J_2002_4</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J_2002_4 </h2>
		...
		<p>Accepted for publication in the Journal of Computational Electronics, 2002.</p>
		...
		<p>Article <a href="../pubs_src/J39.pdf">PDF</a>.</p>
