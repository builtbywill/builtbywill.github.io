...
<head>
    ...
    <title>J_1990_1 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_1990_1">J_1990_1</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J09  </h2>
				
		
		<h3>&quot;Generation and Intensity Correlation Measurements of the Real Gaussian Field&quot;</h3>
		
		<p>Cheng Xie, Gerhard Klimeck and D. S. Elliott</p>
		
		<p>Phys. Rev. A Vol. 41, p.6376 (1990)</p>
		
		<h3>Abstract:</h3> <p>The generation of a broadband laser field with well-defined and controllable statistical properties, known as the real Gaussian laser field, has been achieved through the random modulation of the amplitude of a stabilized laser beam. The verification of the field-generation technique is provided by measurements of the laser power spectrum (Lorentzian) and by measurements of the intensity autocorrelation function. The latter is shown to decrease exponentially from an initial value of nearly 3 to a final value of 1 with a decay time related to the inverse bandwidth of the field. The techniques for generating this field and for its characterization are discussed in this paper.</p>
		
		<p>Request a reprint in <a href="mailto:gekco_no_spaem@kein_spaem.purdue.edu?subject=Request J09.pdf">PDF</a> form.</p>
