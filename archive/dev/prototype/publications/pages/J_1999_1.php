...
<head>
    ...
    <title>J_1999_1 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_1999_1">J_1999_1</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J_1999_1  </h2>
				
		
		<h3>&quot;Interface effects in tunneling models with identical real and complex dispersions&quot;,</h3>
		
		<p>Timothy B. Boykin, Roger K Lake, Gerhard Klimeck, and Mukund Swaminathan,</p>
		
		<p>Phys. Rev. B Vol 59, 7316 (1999).</p>
		
		<h3>Abstract:</h3> <p>Simple heterostructure models are often employed due to their computational efficiency. The approximations involved are not, however, well understood; this is particularly true with respect to the interfaces. In order to clarify this situation we study two different monoatomic (single-band) models and two different diatomic (two-band) models all having identical dispersion relations. We study in detail the relationships between the one- and two-band models, showing that their points of agreement and disagreement arise directly from the handling of the interfaces.</p>
		
		<p>Request a reprint in <a href="mailto:gekco_no_spaem@kein_spaem.purdue.edu?subject=Request J25.pdf">PDF</a> form.</p>
