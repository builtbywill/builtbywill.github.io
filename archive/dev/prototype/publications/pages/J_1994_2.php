...
<head>
    ...
    <title>J_1994_2 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_1994_2">J_1994_2</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J07  </h2>
				
		
		<h3>&quot;Resonant Tunneling through Quantum Dot Arrays&quot;</h3>
		
		<p>Guanlong Chen, Gerhard Klimeck, Supriyo Datta, G. H. Chen and W. A. Goddard III</p>
		
		<p>Phys. Rev. B, Vol. 50, p.8035 (1994)</p>
		
		<h3>Abstract:</h3> <p>We apply the Hubbard Hamiltonian to describe quantum-dot arrays weakly coupled to two contacts. Exact diagonalization is used to calculate the eigenstates of the arrays containing up to six dots and the linear-response conductance is then calculated as a function of the Fermi energy. In the atomic limit the conductance peaks form two distinct groups separated by the intradot Coulomb repulsion, while in the band limit the peaks occur in pairs. The crossover is studied. A finite interdot repulsion is found to cause interesting rearrangements in the conductance spectrum.</p>
		
		<p>Request a reprint in <a href="mailto:gekco_no_spaem@kein_spaem.purdue.edu?subject=Request J07.pdf">PDF</a> form.</p>
