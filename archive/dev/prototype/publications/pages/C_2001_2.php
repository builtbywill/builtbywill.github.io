...
<head>
    ...
    <title>C_2001_2 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
...
<!-- @end mast -->
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2001_2">C_2001_2</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2001_2 </h2>
		...
		<h3>Abstract:</h3> 
		<p>Nano-scaled electronic devices are characterized by material and charge density variations on the length scale
of a few atoms. Typical strucure sizes range from few hundreds to tens of millions of atoms. A nanoelectronic
modeling tool (NEMO-3D) that enables the analysis of the electronic structure of arbitrarily shaped quantum
dots of arbitrary composistion and crystal structure is being developed. A tight-binding model using s, p, and
d orbitals is used to represent the electronic strucutre of realistically sized quantum dots. Parallel algorithms
are employed to compute the single electron states in systems as big as 10 million atoms. An overview of the
simulator and first results dealing with strain, alloyed dots and interface interdiffusion will be presented. More
information about the work can be found at this website <a href="http://hpc.jpl.nasa.gov/PEP/gekco">http://hpc.jpl.nasa.gov/PEP/gekco</a>. </p>
