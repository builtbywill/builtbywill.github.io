...
<head>
    ...
    <title>J_2000_2 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_2000_2">J_2000_2</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J_2000_2 </h2>
				
		
		<h3>sp3s* Tight-Binding Parameters for Transport Simulations in Compound Semiconductors</h3>
		
		<p>Gerhard Klimeck, R. Chris Bowen, Timothy B. Boykin, and Thomas A. Cwik</p>

		
		<p>Superlattices and Microstructures Vol. 27, pp. 519-524 (2000)</p>
		
		
		<h3>Abstract:</h3>
        <p>A genetic algorithm approach is used to fit orbital interaction energies of sp3s* tight-binding models for the nine binary compound semiconductors consistent of Ga, Al, In and As, P, Sb at room temperature. The new parameters are optimized to reproduce the bandstructure relevant to carr ier transport in the lowest conduction band and the highest three valence bands. The accuracy of the other bands is sacrificed for the better reproduction of the effective masses in the bands of interest. Relevant band edges are reproduced to within a few meV and the effective masses deviate from the experimental values typically by less than 10%.</p>
		
		<p><a href="../pubs_src/J29_.pdf">PDF document</a>.</p>
