...
<head>
    ...
    <title>C_2002_1 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
...
<!-- @end mast -->
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2002_1">C_2002_1</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2002_1 </h2>
				
		
		<h3>Atomistic Electronic Structure Calculations of Unstrained Alloyed Systems Consisting of a Million Atoms</h3>


		
		
		<p>Fabiano Oyafuso, Gerhard Klimeck, R. Chris Bowen, and Timothy B. Boykin </p>
		...
		<h3>Abstract:</h3> 
		<p>The broadening of the conduction and valence band edges due to compositional disorder in alloyed materials of finite extent is studied using an sp3s* tight binding model.  Two sources of broadening due to configuration and concentration disorder are identified.  The concentrational disorder dominates for systems up to at least one million atoms and depends on problem size through an inverse square root law. Significant differences (up to 13 meV) in band edge energies are seen depending on choice of granularity of alloy clusters. </p>



		<p>Proceeding article <a href="../pubs_src/J39.pdf">PDF</a>.</p>
