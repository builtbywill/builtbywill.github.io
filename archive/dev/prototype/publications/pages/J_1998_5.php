...
<head>
    ...
    <title>J_1998_5 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_1998_5">J_1998_5</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J_1998_5  </h2>
				
		
		<h3>Numerical approximations to the treatment of interface roughness scattering in resonant tunnelling diodes</h3>
		
		<p>Gerhard Klimeck, Roger K. Lake, and Daniel K. Blanks</p>
		
		<p>Semicond. Sci. Technol. Vol. 13, pg. A165-A168 (1998)</p>
		
		<h3>Abstract:</h3> 
        <p>Current calculations for a resonant tunnelling diode which include a self-consistent Born treatment of interface roughness combined with full charge self-consistency are presented. Approximate but more computationally tractable solutions which either ignore the scattering-assisted charge or the real part of the self-energy are compared with the full solution. The coherent tunnelling calculation combined with quantum charge self-consistency provides an accurate estimate of the resonant current. To obtain the same accuracy while including interface roughness scattering for our particular device requires a treatment of both the real and the imaginary parts of the self-energy combined with a fully self-consistent treatment of the scattering-assisted charge.</p>
		
		<p>Request a reprint in <a href="mailto:gekco_no_spaem@kein_spaem.purdue.edu?subject=Request J22.pdf">PDF</a> form.</p>
