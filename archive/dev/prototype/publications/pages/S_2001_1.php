...
<head>
    ...
    <title>S_2001_1 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/S_2001_1">S_2001_1</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck S_2001_1  </h2>
				
		
		<h3>Quantum Dot Modeling using NEMO 3-D</h3>
		
		<p>Gerhard Klimeck, </p>
		<p>JPL, Section 367 Seminar, February 6, 2001, 126-346, 3p.m.		</p>
