...
<head>
    ...
    <title>P_1999_5 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/P_1999_5">P_1999_5</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck P_1999_5  </h2>
				
		<h3>Evolutionary Design of Electronic Devices and Circuits</h3>
		
		<p>Adrian Stoica, Gerhard Klimeck, Carlos Salazar-Lazaro, Didier Keymeulen, and Anil Thakoor</p>
		
		<p>Proceedings of the 1999 Congress on Evolutionary Computation, July 6 th -9 th , 1999, Washington DC. IEEE Press.</p>
		
		<h3>Abstract:</h3> <p>This paper addresses the use of evolutionary algorithms in the design of electronic devices and circuits. In particular, the paper introduces the idea of evolutionary design of nanodevices, and illustrates it with the design of a resonant tunneling diode. A second experiment, this time using CMOS microdevices, illustrates the use of evolutionary algorithms for circuitdesign. The experiments were facilitated by an Evolutionary Design Tool developed around a parallel implementation of genetic algorithms (using PGAPack), and device/circuit simulators (NEMO and SPICE). It is speculated that in the future devices and circuits may be simultaneously co-designed.		 <a href="../pubs_src/P22.pdf">PDF</a> .
		Requests for reprints can be granted for educational use only.</p>
