...
<head>
    ...
    <title>J_1994_1 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_1994_1">J_1994_1</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J06  </h2>
				
		
		<h3>&quot;Conductance Spectroscopy in Coupled Quantum Dots&quot;</h3>
		
		<p>Gerhard Klimeck, Guanlong L. Chen and Supriyo Datta
		
		<p>Phys. Rev. B, Vol. 50, p.2316 (1994)
		
		<h3>Abstract:</h3> <p>We investigate the linear-response conductance through a pair of coupled quantum dots. The conductance spectrum under ideal conditions is shown to consist of two sets of twin peaks whose locations and amplitudes are determined by the interdot coupling and the intradot charging. We will show that the qualitative features of the spectrum survive against experimental nonidealities such as (1) detuning of the individual dots, (2) interdot charging, (3) inelastic scattering, and (4) multiple lateral states. The effect of higher lateral states depends strongly on the nature of the interaction potential, screening lengths, and exchange terms, but the lowest set of twin peaks is largely unaffected by these details.</p>
		
		<p>Request a reprint in <a href="mailto:gekco_no_spaem@kein_spaem.purdue.edu?subject=Request J06.pdf">PDF</a> form.</p>
