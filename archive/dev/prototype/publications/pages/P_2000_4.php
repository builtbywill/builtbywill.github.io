...
<head>
    ...
    <title>P_2000_4 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
...
<!-- @end mast -->
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/P_2000_4">P_2000_4</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck P_2000_4  </h2>
				
		
		<h3>EHWPack: an Evolvable Hardware Environment using the Spice Simulator and the Field Programmable Transistor Array</h3>
		
		<p>D. Keymeulen, Gerhard Klimeck, R. Zebulum, Adrian Stoica, Yili Jin, Carlos-Salazar Lazaro</p>
		<p>In the Proceedings of ANNIE'2000 (Smart Enginering System Design), St. Louis, MO, November 5-8, 2000		</p>
		<h3>Abstract:</h3> 
		...
		<p>Reprint in <a href="../pubs_src/P26.pdf">PDF</a> form.</p>
