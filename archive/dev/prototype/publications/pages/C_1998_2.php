...
<head>
    ...
    <title>C_1998_2 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_1998_2">C_1998_2</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_1998_2 </h2>
				
		
		<h3>The Well-Tempered Tight-Binding Model: Many Parameters Do Not Necessarily Imply Flexibility</h3>
		
		<p>Timothy Boykin (ECE Dept., U. Alabama Huntsville), Gerhard Klimeck, Roger Lake (Raytheon TI Systems), R. Chris Bowen (Texas Instruments, Inc.)</p>
		
		<p>March meeting of the American Physical Society, 16-20, Los Angeles, CA (1998)</p>
		
		<h3>Abstract:</h3> 
		<p>On first inspection, most empirical tight-binding models would seem able to fit all bandstructure features of interest as they often have relatively many adjustable parameters. A more detailed study, however, reveals that many of these models are strongly limited as to which features they can accurately reproduce. Here we examine the nearest- and second-nearest neighbor sp^3s models, concentrating on the effective masses at \Gamma. Rather interestingly, we find that when these models are applied to heterostructure calculations, those with spin-orbit have a distinct advantage those without, even for conduction-band states.</p>
