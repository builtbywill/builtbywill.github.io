...
<head>
    ...
    <title>J_2002_3 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_2002_3">J_2002_3</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J_2002_3  </h2>
				
		<h3>&quot;Many-body levels of multiply charged and laser-excited InAs nanocrystals modeled by empirical tight binding&quot;,</h3>
			
		<p>Seungwon Lee, Jeoungnim Kim, Lars J&ouml;nsson, John W. Wilkins, Garnett Bryant, and Gerhard Klimeck,</p>
			
		<p>Phys. Rev. B 66, 235307 (2002).</p>
		
		
		<h3>Abstract:</h3>
		
		<p>Request <a href="mailto:gekco_no_spaem@kein_spaem.purdue.edu?subject=Request J38.pdf">PDF preprint document</a>.</p>
