...
<head>
    ...
    <title>J_1998_4 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
...
<!-- @end mast -->
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_1998_4">J_1998_4</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J_1998_4  </h2>
				
		
		<h3>Interface roughness and polar optical phonon scattering in InGaAs/AlAs/InAs RTDs</h3>
		...
		<h3>Abstract:</h3> 
        <p>The contributions of interface roughness scattering and polar optical phonon scattering to the valley current of InGaAs/AlAs/InAs resonant tunnelling diodes (RTDs) are theoretically found to be comparable. An InGaAs/AlAs/InAs RTD design is suggested to experimentally observe the phonon peak which has never been observed in this material system. Such a device will provide a calibration point for the theoretical calculations.</p>
		
		<p>Request a reprint in <a href="mailto:gekco_no_spaem@kein_spaem.purdue.edu?subject=Request J21.pdf">PDF</a> form.</p>
