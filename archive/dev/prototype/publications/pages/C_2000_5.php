...
<head>
    ...
    <title>C_2000_5 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
...
<!-- @end mast -->
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2000_5">C_2000_5</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2000_5  </h2>
				
		
		<h3>Atomistic Simulation of Quantum Dots Including Strain and Bandstructure</h3>
		
		<p>Gerhard Klimeck, R. Chris Bowen, and Timothy B. Boykin</p>
		
		<p>Electronic Materials Conference, Denver, CO, June 21-23, 2000.</p>
		...
		<p>[1] G. Klimeck, et al, accepted in Superlattices and Microstructures (2000).
		[2] P. Keating, Phys. Rev. v.145, p.637, (1966).</p>
