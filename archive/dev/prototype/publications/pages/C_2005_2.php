...
<head>
    ...
    <title>C_2005_2 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2005_2">C_2005_2</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2005_2 </h2>
				
		<h3>Fano quadrupole in a nanoscale ring</h3>
		
		
		<p>A. M. Satanin, Y. S. Joe, and G. Klimeck</p>
		
		<p>APS March Meeting, Los Angeles, CA, March 21-25, 2005</p>
		
		<h3>Abstract:</h3>
		<p>Modern nanotechnology provides various solid state systems such as Aharonov-Bohm (AB) rings, two-dimensional (2D) electronic waveguides, and nanotubes, where alternative electronic paths may be realized. In these systems, interference of a localized wave with propagating states produces Fano resonances in the conductance. The scattering amplitude near Fano zero-pole pair behaves like the amplitude a dipole when the pole (long living excitation) plays role of a particle and the zero (hole) plays role of an antiparticle [1]. This separate Fano-dipole has been already observed in the AB ring with an embedded quantum dot (QD) [2]. In the present work, we examine new effects on the collision of Fano dipoles and its manifestation in the transmission. The numerical results for a realistic AB ring with two embedded QDs will be presented. We show that the two Fano-dipoles form a new quasi-particle, which behaves as a coupled object  the Fano quadrupole. This property gives an additional possibility of manipulating transmission resonances (a collapse of particle and hole) in a nanoscale ring by changing the parameters of the system. We discuss an analogy of Fano collision in an AB ring and a Gamma-X barrier [3].
			
[1] Z. Shao, W. Porod, and C. S. Lent, Phys. Rev. B 49, 7453 (1994). 

[2] K. Kobayashi, H. Aikawa, S. Katsumoto, and Y. Iye, Phys. Rev. Lett., 85, 256806 (2002). 

[3] R.C.Bowen, W.R.Frensley, G.Klimeck, and R.K.Lake, Phys. Rev. B 52, 2754 (1995). 
