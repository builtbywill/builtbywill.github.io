...
<head>
    ...
    <title>J_1996_1 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_1996_1">J_1996_1</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J_1996_1  </h2>
				
		
		<h3>&quot;Ultrafast Characteristics of InGaP/InGaAlP Laser Amplifiers&quot;</h3>
		
		<p>Jim A Tatum, Duncan L. MacFarlane, R. Chris Bowen, Gerhard Klimeck and William R. Frensley,</p>
		
		<p>IEEE J. of Quantum Electronics, Vol. 32, p.664 (1996).</p>
		
		<h3>Abstract:</h3><p> We characterize a visible, 670 nm, diode laser amplifier with respect to parameters of interest in short pulse generation and amplification, With a single pulse in the amplifier, we measure the differential gain and saturation energy of the amplifier, and changes in the optical spectrum of a pulse traveling through the amplifier, We also measure the ultrafast gain dynamics using a pump and probe technique, We find the ultrafast gain recovery time due to carrier heating is 400 fs +/- 30 fs, Our results differ quantitatively from those reported for InGaAsP and AlGaAs amplifiers.</p>
		
		<p>Request a reprint in <a href="mailto:gekco_no_spaem@kein_spaem.purdue.edu?subject=Request J11.pdf">PDF</a> form.</p>
