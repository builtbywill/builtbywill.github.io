...
<head>
    ...
    <title>P_2001_5 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
...
<!-- @end mast -->
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/P_2001_5">P_2001_5</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck P_2001_5 </h2>
				
		
		<h3>Applications on High Performance Cluster Computers Production of Mars Panoramic Mosaic Images</h3>
		
		<p>Tom Cwik, Gerhard Klimeck, Myche McAuley, Bob Deen and Eric Dejong</p>
		
		<p>Proceedings of the2001 <a href="http://ulua.mhpcc.af.mil/AMOS/conf_01.html">AMOS Technical Conference</a>, September 10-14, Maui,</p>
		...
		<p>One application currently under development to utilize cluster computer resources is the production of Martian surface mosaic images from a collection of individual images shot from a rover camera.  The mosaic production software was ported to a commodity cluster computer system as a proof-of-concept for near real-time processing of the downlink data.  This talk will describe the requirements for parallelization of the algorithms as well as performance improvements using the cluster computer that enable its use in real-time mission operations.</p>
		
		<p>Proceeding article <a href="../pubs_src/P32.pdf">PDF</a>.</p>
