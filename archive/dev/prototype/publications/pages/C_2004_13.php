...
<head>
    ...
    <title>C_2004_13 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2004_13">C_2004_13</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2009_10 </h2>
				
		
		<h3>The effect of the strain relaxation in InAs/GaAs stacked quantum dots and multiple quantum wells on the Raman spectrum</h3>
		
		<p>Olga L. Lazarenkova, Paul von Allmen, Seungwon Lee, Fabiano Oyafuso, and Gerhard Klimeck</p>
		<p>March Meeting of the American Physical Society, March 22-26, Montreal, CA (2004).</p>
		<h3>Abstract:</h3> 
		
		<p>Atomistic-level simulations of the Raman shift in InAs/GaAs multiple quantum well (MQW) and
stacked quantum dot (SQD) structures as a function of interlayer separation are reported. The simulations
utilize an augmented Keating model which includes anharmonicity corrections. It is demonstrated that the
interaction between angle distorted bonds is responsible for the penetration of the strain into the GaAs barrier.
This result is in contrast to a complete strain relaxation of the GaAs barrier which would be predicted by
continuum models. Tension along the growth direction result in the red shift of the GaAs LO Raman peak as
the barrier thickness decreases in both, MQW and SQD, structures.</p>
