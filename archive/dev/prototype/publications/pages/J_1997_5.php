...
<head>
    ...
    <title>J_1997_5 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/J_1997_5">J_1997_5</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck J_1997_5  </h2>
				
		
		<h3>&quot;Effective Mass Reproducibility of the Nearest-Neighbor sp3s* Models: Analytic Results&quot;,</h3>
		
		<p>Timothy B. Boykin, Gerhard Klimeck, R. Chris Bowen, and Roger Lake,</p>
		
		<p>Phys. Rev. B Vol 56, 4102 (1997).</p>
		
		<h3>Abstract:</h3> 
        <p>We derive the exact expressions for the effective masses of the conduction and all three hole bands at Gamma in the nearest-neighbor sp3s* model, both with and without the spin-orbit interaction. From these expressions we find that the nearest-neighbor sp3s* model can usually fit the electron mass better than the light- and heavy-hole masses and will not be equally successful across a broad spectrum of materials. &copy; 1997 The American Physical Society.</p>
		
		<p>Request a reprint in <a href="mailto:gekco_no_spaem@kein_spaem.purdue.edu?subject=Request J17.pdf">PDF</a> form.</p>
