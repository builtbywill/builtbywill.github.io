...
<head>
    ...
    <title>C_2001_9 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2001_9">C_2001_9</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2001_9 </h2>
				
		
		<h3>Quantum Dot Modeling using NEMO 3-D, or Development of a Bottom-Up Nanoelectronic Simulator</h3>
		
		<p>Gerhard Klimeck, Fabiano Oyafuso, R. Chris Bowen,  Timothy B. Boykin, Tom Cwik, Edith Huang, Edward Vinyard,</p>
		
		<p>Sackler Colloquium, National Academy of Sciences, Washington DC, May 18-20 (2001)</p>
		
		<h3>Abstract:</h3> 
		
		<p>View <a href="(Empty Reference!)">Poster</a>.</p>		
