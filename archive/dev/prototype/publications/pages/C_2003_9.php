...
<head>
    ...
    <title>C_2003_9 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2003_9">C_2003_9</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2003_8 </h2>
				
		
		<h3>Electron-spin g-factor engineering with SiGe heterostructures</h3>
		
		<p>Seungwon Lee, Gerhard Klimeck, and K. Birgitta Whaley,		</p>
		<p>Spintech II International Conference and School, Semiconductor Spintronics and Quantum Information Technology. It is held on August 4-8, 2003 at Brugge, Belgium.</p>
		
		<h3>Abstract:</h3> 
		<p>Electron-spin g-factor engineering with SiGe heterostructures is a promising candidate for single-qubit logic gates thanks to a fast manipulation, a long spin coherence time and a scalability of the number of quantum bits. The g-factors of the electron spins are investigated with spds* nearest-neighbor tight-binding model. The electrons are modeled to be bound by either donor impurities or quantum dots. Tight-binding calculations for the dependences of the g-factor on Si/Ge compositions, strain, and dot sizes are presented.</p>
