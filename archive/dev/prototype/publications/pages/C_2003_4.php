...
<head>
    ...
    <title>C_2003_4 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2003_4">C_2003_4</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2003_4 </h2>
				
		
		<h3>Structure of Transverse Electron Current in Resonant Tunneling Diodes and Breakdown of Tsu-Esaki Formula</h3>
		
		<p>Titus Sandu, Gerhard Klimeck, and Wiley P. Kirk,</p>
		<p>March Meeting of the American Physical Society, March 16-21, Austin, TX (2003).		</p>
        <h3>Abstract:</h3> 
        <p>We studied the transverse structure of electron current in resonant tunneling diodes (RTDs). The coherent transport of electrons, which is described by Tsu-Esaki formula, induces zone-center current flow of electrons in RTDs. By comparison, the coherent transport of holes has off-zone-center current flow due to the mixing of heavy and light holes. By including incoherent scattering we show that, in general, electron current flow is also off-center, i.e. the hole behavior is extended to electrons and is related to the breakdown of the Tsu-Esaki formula. Oblique flow is due to incoherent scattering represented by interface roughness and acoustic phonons. 		</p>
