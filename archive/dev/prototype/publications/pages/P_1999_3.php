...
<head>
    ...
    <title>P_1999_3 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/P_1999_3">P_1999_3</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck P_1999_3  </h2>
				
		
		<h3>&quot;Genetically Engineered&quot; Nanoelectronics</h3>
		
		<p>Gerhard Klimeck, Carlos H. Salazar-Lazaro, Adrian Stoica, and Thomas Cwik</p>
		
		<p>Proceedings of the First NASA/DoD Workshop on Evolvable Hardware, IEEE 1999 , Page(s): 247 -248.</p>
		
		<h3>Abstract:</h3> 
        <p>The quantum mechanical functionality of nanoelectronic devices such as resonant tunneling diodes (RTDs), quantum well infrared photodetectors (QWIPs), quantum well lasers, and heterostructure field effect transistors (HFETs) is enabled by material variations on an atomic scale. The design and optimization of such devices requires a fundamental understanding of electron transport in such dimensions. The Nanoelectronic Modeling Tool (NEMO) is a general-purpose quantum device design and analysis tool based on a fundamental non-equilibrium electron transport theory. NEMO was combined with a parallelized genetic algorithm package (PGAPACK) to evolve structural and material parameters to match a desired set of experimental data. A numerical experiment that evolves structural variations such as layer widths and doping concentrations is performed to analyze an experimental current voltage characteristic. The genetic algorithm is found to drive the NEMO simulation parameters close to the experimentally prescribed layer thicknesses and doping profiles. With such a quantitative agreement between theory and experiment design synthesis can be performed.</p>
		
		<p>Request a reprint in <a href="mailto:gekco_no_spaem@kein_spaem.purdue.edu?subject=Request P20.pdf">PDF</a> form.</p>
