...
<head>
    ...
    <title>C_2004_3 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2004_3">C_2004_3</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2004_3 </h2>
				
		
		<h3>Sensitivity and response time of palladium nanowire hydrogen sensors</h3>
		
		<p>Paul von Allmen, Seungwon Lee, Fabiano Oyafuso, Gerhard Klimeck</p>
		<p>March Meeting of the American Physical Society, March 22-26, Montreal, CA (2004).</p>
		<h3>Abstract:</h3> 
		<p>The resistivity change in palladium induced by hydrogen absorption has been used to build hydrogen sensors for several decades. Recent advances in the fabrication of nanowires is raising the question of how the sensor sensitivity and response time change with the diameter. We have developed an empirical model for the absorption of hydrogen into palladium. The parameters of the model are fitted to reproduce the experimental data for the pressure-concentration phase diagram, Sievert's law for the pressure dependence of absorption, and the pressure dependence of the initial absorption rate. This model predicts that the sensitivity does not depend on the nanowire diameter whereas the response time increases with diameter.</p>
