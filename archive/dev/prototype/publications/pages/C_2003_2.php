...
<head>
    ...
    <title>C_2003_2 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2003_2">C_2003_2</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2003_2 </h2>
				
		
		<h3>Diagonal parameter shifts in strained semiconductors in the empirical tight-binding theory</h3>
		
		<p>Timothy B. Boykin, Gerhard Klimeck, R. Chris Bowen, and Fabiano Oyafuso,</p>

		<p>March Meeting of the American Physical Society, March 16-21, Austin, TX (2003).		</p>
		<h3>Abstract:</h3> 
		
		<p>Many empirical tight-binding models require adjustment to the diagonal parameters in order to correctly reproduce the behavior of the band edges under uniaxial strain.  These adjustments typically take the form of one or two additional parameters which shift the p- and/or d-onsite
parameters.  Such adjustments, while satisfactory in the case of uniaxial strain, are of little use in nano-structure models, where the atoms can be irregularly positioned.  To address this case we present our method for determining the diagonal parameter shifts in the case of arbitrary atomic
displacements.  Our results agree well with other available exerimental or theoretical data for the cases of uniaxial and hydrostatic strain, yet are not at all restricted to these situations.</p>
