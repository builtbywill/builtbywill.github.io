...
<head>
    ...
    <title>C_2002_9 \ The Nanoelectronic Modeling Group \ Purdue University</title>
    <!-- InstanceEndEditable -->
    	...
    	<div class="center">
            <div id="crumbs">
                ...
                <!-- InstanceBeginEditable name="breadcrumbs" --> 
                    ...
                    &gt; <a href="<?php echo $siteRoot; ?>publications/pages/C_2002_9">C_2002_9</a>
                <!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
		
		<h2>Gerhard Klimeck C_2002_9 </h2>
				
		
		<h3>Transport Simulation of Precessing Spin Distribution across Semiconductor Heterojunctions</h3>
		
		<p>Paul von Allmen and Gerhard Klimeck,  		</p>
		<p>Nanospace 2002, Galveston, TX, June 24-28, 2002. </p>	
		<h3>Abstract:</h3> <p>Several magneto-optic experiments have recently studied the transport of precessing spins across a semiconductor heterojunction. It was found that a spin polarized electron distribution efficiently diffuses from a GaAs substrate to a ZnSe epilayer [1]. Time resolved Faraday rotation measurements have shown that the dynamics of electrons accumulated in the epilayer is determined by the ZnSe Land&eacute; factor and spin relaxation time. Later measurements have shown that the spin dynamics changes from ZnSe to GaAs in nature if a potential drop is applied between the epilayer and the substrate [2]. We will present numerical results that reproduce these experimental data and shows that the shift in spin dynamics is determined by the relative time scales of spin diffusion and Larmor precession. The model relies on a continuity equation for spin accumulation as was used for the study of the spin momentum transfer mechanism [3].</p>
		<p>
...
View <a href="../pubs_src/C78.pps">Powerpoint file</a>.
