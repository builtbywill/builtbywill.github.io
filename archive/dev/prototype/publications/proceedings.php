...
<head>
    ...
    <title>Conference Proceedings Publications \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    <!-- InstanceEndEditable -->
    ...
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                &gt; <a href="<?php echo $siteRoot; ?>publications/proceedings">Proceedings</a>
			<!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
                <h2>Conference Proceedings Publications</h2>
                <p>These peer-reviewed proceedings articles are typically extended abstracts made available to conference participants. Some of the articles are also publicly available in conference archives such as IEEE IEDM, IEEE DRC, IEEE SISPAD, IEEE Nano, IEEE AP-S, and Inst. Phys. Conf. Ser. The conference participation is also shown in the list of conferences.</p>
                <ul>
                    <li><a href="#Nanoelectronics at JPL">Nanoelectronics, Genetic Algorithms, and Cluster computing</a></li>
                    <li><a href="#NEMO Related Publications">NEMO Related Work at Raytheon / TI / UTD</a></li>
                    <li><a href="#PHD Publications">Quantum Dots, RTD's and 2DEG's at Purdue</a></li>
                </ul>
				<?php 
				//Set up path to XML
				//Load XML	
				...
				$pList = $doc->getElementsByTagName("item");

				//Nanoelectronics
				echo "<h3><a name=\"Nanoelectronics at JPL\"></a>Nanoelectronics, Genetic Algorithms, and Cluster computing</h3>";
				echo listItems("nano", $pList);
				
				//NEMO Related
				echo "<h3><a name=\"NEMO Related Publications\"></a>NEMO Related Work at Raytheon / TI / UTD</h3>";
				echo listItems("nemo", $pList);
				
				//PHD Related
				echo "<h3><a name=\"PHD Publications\"></a>Quantum Dots, RTD's and 2DEG's at Purdue</h3>";
				echo listItems("phd", $pList);
			?>
			<!-- InstanceEndEditable --> 
            </div>
            <div class="side-col">
