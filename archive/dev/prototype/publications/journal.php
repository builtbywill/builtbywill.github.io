...
<head>
    ...
    <title>Journal Publications \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    <!-- InstanceEndEditable -->
    ...
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                &gt; <a href="<?php echo $siteRoot; ?>publications/journal">Journal</a>
			<!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
                ...
                <ul>
                    <li><a href="#Submitted Articles">Submitted Articles</a></li>
                    <li><a href="#Nanoelectronics">Nanoelectronics</a></li>
                    ...
                    <li><a href="#Masters Publications">Non-linear Optics at Purdue</a></li>
                </ul>
				<?php 
				//Set up path to XML
				//Load XML	
				...
				$jList = $doc->getElementsByTagName("item");
				
				//Submitted Articles
				echo "<h3><a name=\"Submitted Articles\"></a>Submitted Articles</h3>";
				echo listItems("submitted", $jList);
				
				//Nanoelectronics
				echo "<h3><a name=\"Nanoelectronics\"></a>Nanoelectronics</h3>";
				echo listItems("nano", $jList);
				
				//NEMO Related
				echo "<h3><a name=\"NEMO Related Publications\"></a>NEMO Related Work at Raytheon / TI / UTD</h3>";
				echo listItems("nemo", $jList);
				
				//PHD Related
				echo "<h3><a name=\"PHD Publications\"></a>Quantum Dots, RTD's and 2DEG's at Purdue</h3>";
				echo listItems("phd", $jList);
				
				//Masters Related
				echo "<h3><a name=\"Masters Publications\"></a>Non-linear Optics at Purdue</h3>";
				echo listItems("masters", $jList);
