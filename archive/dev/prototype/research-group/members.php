<?php 
	...
	if(!empty($getUser))
	{
		...
		$query = "//people/person[@type='member']/login[. = '".$getUser."']";
...
<head>
    ...
    <title><?php if(!empty($getUser)){ echo $name." \\\\ ";}?>Members \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    ...
    <div id="content">
    	<div class="center">
			...
			<?php
                ...
                <?php if(!empty($getUser)){ ?> &gt; <a href="members?id=<?php echo $getUser;?>"><?php echo $name;?></a><?php } ?>           
                <?php if(!empty($getPage) && $getPage != "bio"){ ?> &gt; <a href="members?id=<?php echo $getUser;?>&amp;page=<?php echo $getPage;?>"><?php echo $title;?></a><?php } ?>           
              </div>
            <div class="main-col">
            <?php
								if($getPage == "bio"){
            ...
            <div class="main-col">
            <?php
				echo "<h2>Member Gallery</h2>";
				echo peopleBrowser("member");
					
				echo "<h2>Research Faculty and Post-Doctoral Researchers</h2>";
				echo listPeople("member","Research Faculty and Post-Doctoral Researcher"); 
				
				echo "<h2>Ph.D. Students</h2>";
				echo listPeople("member","Ph.D. Student"); 
			   
				echo "<h2>Current Master's Students</h2>";
				echo listPeople("member","Current Master's Student"); 
			   
				echo "<h2>Undergraduate Students</h2>";
				echo listPeople("member","Undergraduate Student"); 
