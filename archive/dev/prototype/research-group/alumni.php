<?php 
	...
	if(!empty($getUser))
	{
		...
		$query = "//people/person[@type='alumni']/login[. = '".$getUser."']";
...
<head>
    ...
    <title><?php if(!empty($getUser)){ echo $name." \\\\ ";}?>Alumni \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    ...
    <div id="content">
    	<div class="center">
			...
			<?php
                ...
                <?php if(!empty($getUser)){ ?> &gt; <a href="alumni?id=<?php echo $getUser;?>"><?php echo $name;?></a><?php } ?>           
                <?php if(!empty($getPage) && $getPage != "bio"){ ?> &gt; <a href="alumni?id=<?php echo $getUser;?>&amp;page=<?php echo $getPage;?>"><?php echo $title;?></a><?php } ?>           
              </div>
            <div class="main-col">
            <?php
								if($getPage == "bio"){
            ...
            <?php }else{ 
                ...
                &gt; <a href="alumni?id=<?php echo $getUser;?>"><?php echo $name;?></a>
				<?php } ?>           
                <?php if(!empty($getPage)){ ?> 
                &gt; <a href="alumni?id=<?php echo $getUser;?>&amp;page=<?php echo $getPage;?>"><?php echo $title;?></a>
				<?php } ?>           
              </div>
            <div class="main-col">
            <?php
				echo "<h2>Alumni Gallery</h2>";
				echo peopleBrowser("alumni");
					
				echo "<h2>Former Post-Doctoral Researchers</h2>";
				echo listPeople("alumni","Former Post-Doctoral Researcher"); 
				
				echo "<h2>Graduated Ph.D. Students</h2>";
				echo listPeople("alumni","Graduated Ph.D. Student"); 
			   
				echo "<h2>Graduated Master's Students</h2>";
				echo listPeople("alumni","Graduated Master's Student"); 
			   
				echo "<h2>Former Undergraduate Research Students</h2>";
				echo listPeople("alumni","Former Undergraduate Research Student"); 
			   
				echo "<h2>Former Master's Students</h2>";
				echo listPeople("alumni","Former Master's Student"); 
			   
				echo "<h2>Former Ph.D. Students</h2>";
				echo listPeople("alumni","Former Ph.D. Student"); 
