...
<head>
    ...
    <title>Nanowire \\ nanoHUB \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    <!-- InstanceEndEditable -->
    ...
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                &gt; <a href="<?php echo $siteRoot; ?>software-projects/nanoHUB/nanowire">nanowire</a>
				<!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
			<h2>Full 3D Volume Rendering of Electrostatic Potentials and Electron Densities</h2>
            <p>The nanoVIS technology integrated into the Rappture and nanoHUB middleware allows developers to deploy tools that provide rapid and fully integrated volume rendering of 3D data. </p>
            <p>Below are screen sot seqences taken from the nanowire tool which illustrate the development of the electron charge and the electrostatic potentialinside a circular nanowire .</p>
            <p><img src="nanohub_img/density3d_pot1d_dens1d_830p.gif" alt="" width="838" height="514" border="0"></p>
            <p><img src="nanohub_img/potential3d_pot1d_830pix.gif" alt="" width="838" height="514" border="0"></p>
			<!-- InstanceEndEditable --> 
            </div>
            <div class="side-col">
