...
<head>
    ...
    <title>Bandstructure Development \\ nanoHUB \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    <!-- InstanceEndEditable -->
    ...
    <div id="mast">
        ...
        <div class="center header-subpage">
			<!-- InstanceBeginEditable name="header1" -->
                <h1>nanoHUB Educational Applications</h1>
            <!-- InstanceEndEditable -->
        </div>
    </div> 
<!-- @end mast -->
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                &gt; <a href="<?php echo $siteRoot; ?>software-projects/nanoHUB/bandstructure">Bandstructure Development</a>
				<!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
			<h2>Bandstructure Development</h2>
		<p><a href="http://nanoHUB.org">nanoHUB.org</a> enables the assembly of animated image sequences which can be powerful tols for illustration in educational settings.  The images below are taken from the &quot;Piecewise Contentant Potential Lab&quot; and illustrate nicely various concepts of bandstructure formation in open systems as well as quasi-periodic structures.</p>
		<p>Barrier height 110meV, well width 6nm barrier width 2nm:<img src="nanohub_img/B_T_O_011eV_2_6nm_933pix.gif" alt="" width="933" height="365" border="0"></p>
		<p>Barrier height 400meV, well width 6nm barrier width 2nm:<img src="nanohub_img/B_T_O_04eV_2_6nm_931pix.gif" alt="" width="932" height="365" border="0"></p>
		<p>Barrier height 400meV, well width 8nm barrier width 2nm:<img src="nanohub_img/B_T_O_04eV_2_10nm_931pix.gif" alt="" width="932" height="365" border="0"></p>
			<!-- InstanceEndEditable --> 
            </div>
            <div class="side-col">
