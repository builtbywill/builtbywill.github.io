...
<head>
    ...
    <title>History \\ OMEN \\ The Nanoelectronic Modeling Group \\ Purdue University</title>
    <!-- InstanceEndEditable -->
    ...
    <div id="content">
    	<div class="center">
            <div id="crumbs">
                ...
                &gt; <a href="<?php echo $siteRoot; ?>software-projects/omen/history">History</a>
				<!-- InstanceEndEditable -->
            </div>
            <div class="main-col">
			<!-- InstanceBeginEditable name="content" -->
			<h2>OMEN History and Availability</h2>
            <p>Dr. Mathieu Luisier developed the first prototype at ETH under the name Greensolver. He joined Purdue as a Research Professor and is the principal developer of OMEN that combines the <a href="../nemo1D/">NEMO1D</a> and <a href="../nemo3D/">NEMO3D</a> concepts to enable the modeling of carrier transport in nanoscaled semicondctor devices in a full 3-D representation.</p>
        
            <p>OMEN currently powers &quot;<a href="http://nanohub.org/tools/bandstrlab/">Bandstructure Lab</a>&quot; on nanoHUB.org after developments by Abhijeet Paul.</p>
            <p>The development of OMEN is supported by various grants from NSF (PetaApps Award, and NCN seed funding), Intel, and the Purdue Research Foundation.</p>
            <p>We are planning to release the source code to the community for use and improvements.</p>
            <p>At this time the code is under rapid development and we are not able to support the distribution and the associated users.</p>
			<!-- InstanceEndEditable --> 
            </div>
            <div class="side-col">
