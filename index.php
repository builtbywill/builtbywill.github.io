...
<?php include("-/php/analytics.php"); ?>
	<header>
    	<h1>Built By Will</h1>
        <ul>
        	<li><a href="#" title="gmail" id="gmail_link">gmail</a></li>
    ...
    <section id="content">
        ...
        <ul id="content-list">
        	<li>
            	<a href="http://purdue.edu/studio" title="Studio by Purdue">            		
            ...
            <li>
            	<a href="/code/booklet/" title="Booklet jQuery Plugin">	            	
            ...
            <li>
            	<a href="http://github.com/builtbywill" title="github/builtbywill">	            	
