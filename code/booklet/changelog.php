...
?>
        ...
        <p>Using the <strong>$("#mybook").data("booklet")</strong> method, access to the Booklet() object is now open, giving access to some public methods listed below. See the <a href="documentation">options page</a> or <a href="demos/methods">direct api examples</a> for more information.</p>
        ...
        <ul>
            <li><a href="demos/closed">autoCenter</a></li>
            <li><a href="demos/arrows">arrowsHide</a></li>
            <li><a href="demos/auto">auto</a></li>
            <li><a href="demos/auto">delay</a></li>
            <li><a href="demos/auto">play</a></li>
            <li><a href="demos/auto">pause</a></li>
        </ul>
        ...
        <p>The <a href="demos/callbacks">before and after callbacks</a> can now access an optional "options" variable.</p>
        
        <h3>1.0.2</h3>
        <h4>December 1, 2010</h4>
        <p>New options have been added as well as streamlining certain parts of the code.</p>
        <ul>
            <li><a href="demos/hovers">hovers</a></li>
            <li><a href="demos/closed">closed</a></li>
            <li><a href="demos/closed">covers</a></li>
            <li><a href="demos/closed">closedFrontTitle</a></li>
            <li><a href="demos/closed">closedFrontChapter</a></li>
            <li><a href="demos/closed">closedBackTitle</a></li>
            <li><a href="demos/closed">closedBackChapter</a></li>
            <li><a href="demos/padding">pagePadding</a></li>
        </ul>
        
        <h3>1.0.1</h3>
        <h4>November 29, 2010</h4>
        <p>Added <a href="demos/direction">direction</a> option. Allows for <strong>RTL</strong> or <strong>LTR</strong> book flipping and organization.</p>
