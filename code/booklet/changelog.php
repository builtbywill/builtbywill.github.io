...
<head>
    ...
    $(function() {
        $('#past-updates').hide();
		$('#past-updates-toggle').click(function(e){
			e.preventDefault();
			$('#past-updates').slideToggle();
		});
    });
    </script>
</head>
    ...
    <div id="header">
        <div class="wrap">
            ...
            <ul id="nav">
                ...
                <li><a href="changelog" class="current">Change Log</a></li>
            </ul>
        </div>
    </div>
    <div id="content">
        <div class="wrap">    	
            ...
            <div class="col-2-third"> 
                ...
                <a href="#" id="past-updates-toggle">Past Updates</a>
                <div id="past-updates">
                <h3>1.4.0</h3>
				<h4>August 8, 2012</h4>
				<h5>Major Changes</h5>
