...
function viewbook(target, options, id){
	...
	var self, opts, vb, 
		...
		pagesRTL = new Array(), titlesRTL = new Array(), chaptersRTL = new Array(), typesRTL = new Array(),
	...
	$.extend(self,
	{
		...
		resetPages: function(){
			...
			if(opts.pageNumbers){
				...
				pNwrap.append('<div class="vb-counter">'+(p-2)+'</div>');
				p0wrap.append('<div class="vb-counter">'+(p-1)+'</div>');
				p1wrap.append('<div class="vb-counter">'+(p)+'</div>');
				p2wrap.append('<div class="vb-counter">'+(p+1)+'</div>');
				p3wrap.append('<div class="vb-counter">'+(p+2)+'</div>');
				p4wrap.append('<div class="vb-counter">'+(p+3)+'</div>');
				
				if(opts.direction == 'RTL'){
					$('.vb-counter').remove();
					p = Math.abs((opts.pTotal-1) - opts.curr); 
					pNwrap.append('<div class="vb-counter">'+(p+3)+'</div>');
					p0wrap.append('<div class="vb-counter">'+(p+2)+'</div>');
					p1wrap.append('<div class="vb-counter">'+(p+1)+'</div>');
					p2wrap.append('<div class="vb-counter">'+(p)+'</div>');
					p3wrap.append('<div class="vb-counter">'+(p-1)+'</div>');
					p4wrap.append('<div class="vb-counter">'+(p-2)+'</div>');
				}
			}
		},
